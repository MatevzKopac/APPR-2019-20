...
#graf1- zaposleni glede na regijo xx 
#graf2- zaposleni glede na dejavnost xx 
#graf3- profit/leto xx
#graf4-dohod3ek/kraj xx
#graf5- dohodek/dejavnost do 10 
#graf6- dohodek/dejavnost od 10 do 30 
#graf7-dohodek/dejavnost od 30 do 100
#graf8-dohodek/dejavnost več kot 100 
#graf9- dohodek/leto do 10 
#graf10- dohodek/leto od 10 do 30 
#graf11-dohodek/leto od 30 do 100
#graf12-dohodek/leto več kot 100 
...
```{r Zaposleni_v_regiji, echo=FALSE, fig.align='center', warning=FALSE}
print(graf1)

```
Zaposlene sem razvrstil tudi glede na vrsto dejavnosti, ki jo opravljajo. Dejavnosti sem delil na 9 kategorij in sicer:
1.	Alternativne oblike zdravljenja 
2.	Bolnišnična zdravstvena dejavnost 
3.	Dejavnost nastanitvenih ustanov za bolniško nego
4.	Dejavnost nastanitvenih ustanov za oskrbo duševno prizadetih, duševno obolelih in zasvojenih oseb
5.	Dejavnost nastanitvenih ustanov za oskrbo starejših in invalidnih oseb
6.	Druge zdravstvene dejavnosti
7.	Specialistična zunajbolnišnična zdravstvena dejavnost
8.	Splošna zunajbolnišnična zdravstvena dejavnost
9.	Zobozdravstvena dejavnost
...
```{r Dobiček, echo=FALSE, fig.align='center', warning=FALSE}
print(graf3)
```
...
Opazimo tufi hitro znižanje dobička pri splošni zunajbolnišnični dejavnosti.
